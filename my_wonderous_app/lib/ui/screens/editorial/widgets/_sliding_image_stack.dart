        ...
        child: ValueListenableBuilder(
          ...
          builder: (context,value, child) {
            ...
            if(yPos != null && height != null) {
              ...
              pctVisivle = (amtVisible / height) .clamp(0, 3);
              ...
              children: [
                TopRight(
                  child: FractionalTranslation(
                      translation: Offset(0, -.1 + .2 * pctVisivle),
                      child: buildPhoto(.73, type.photo3, Alignment(0, -.3 + .6 * pctVisivle)),
                  ),
                ),
                BottomLeft(
                  child: FractionalTranslation(
                    translation: Offset(0, -.14 * pctVisivle),
                    child: buildPhoto(.45, type.photo4, Alignment(0, .3 - .6 * pctVisivle),
                      top: false
                    ),
                  ),
                )
