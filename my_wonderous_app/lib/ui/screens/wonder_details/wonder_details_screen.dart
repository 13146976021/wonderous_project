...
class _WonderDetailsScreenState extends State<WonderDetailsScreen>  with GetItStateMixin,SingleTickerProviderStateMixin {

  //切换控制器
  late final _tabController = TabController(
      length: 4, 
      vsync: this,
    initialIndex:_calmpIndex(widget.tabIndex)
  ...
  //设置边界值
  int _calmpIndex(int index) => index.clamp(0, 3);
